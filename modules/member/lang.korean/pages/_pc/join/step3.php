...
<div id="pages_join">
	...
	<td>
		<div id="addrbox">
		<div>
		<input type="text" name="zip" id="zip" value="" maxlength="5" size="5" readonly="readonly" class="input" /> 
	...
	<td colspan="3">
		<div>
		<input type="text" name="comp_zip" id="comp_zip" value="" maxlength="5" size="5" readonly="readonly" class="input" /> 
