...
<div id="pages_join">
	...
	<td>
		<div id="addrbox">
		<div>
		<input type="number" name="zip" id="zip" value="" maxlength="5" size="5" readonly="readonly" class="input" /> 
	...
	<td>
		<div>
		<input type="number" name="comp_zip" id="comp_zip" value="" maxlength="5" size="5" readonly="readonly" class="input" /> 
