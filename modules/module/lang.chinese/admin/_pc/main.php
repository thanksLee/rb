	...
	<div class="col-md-4 col-lg-3" id="tab-content-list">
		<div class="panel panel-default">
			...
			<div class="list-group visible-xs visible-sm">
				...
				<a class="list-group-item<?php if($BR['id']==$id):?> active<?php endif?>" data-toggle="modal" href="#module-info" onclick="getAjaxData('<?php echo $g['s']?>/?r=<?php echo $r?>&m=<?php echo $m?>&module=<?php echo $module?>&id=<?php echo $BR['id']?>&front=modal.main','module-info');">
					<?php if($BR['hidden']):?><span class="badge">
						<i class="fa fa-eye-slash fa-lg"></i>
					</span><?php endif?><?php echo $BR['name']?>
					<span class="text-muted">(<?php echo $BR['id']?>)</span>
