	...
	<div class="panel-body">
		<div class="row site">
				...
				<ul id="siteorder2" class="list-inline visible-xs visible-sm">
					...
					<li>
						<a data-toggle="modal" href="<?php echo $g['s']?>/?r=<?php echo $S['id']?>&amp;m=<?php echo $m?>&amp;module=<?php echo $module?>#home-modal-site-info">
							<span class="fa-stack fa-lg" style="text-align:center;">
							  <i class="fa fa-square-o fa-stack-2x<?php if($S['uid']==$R['uid']):?> text-primary<?php endif?>"></i>
	...
	<div class="modal-dialog">
	  <div class="modal-content">
		...
		<div class="modal-footer">
			<button class="btn btn-primary btn-block btn-lg" type="submit">사이트 속성 변경</button>
