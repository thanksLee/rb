			...
			<div class="form-group">
				...
				<div class="col-md-10 col-lg-9">
					<div class="btn-group btn-group-justified" data-toggle="buttons">
						<a href="#codeBox" class="btn btn-default<?php if(!$R['uid']||$R['pagetype']==3):?> active<?php endif?>" data-toggle="tab" onclick="document.procForm1.pagetype.value='3';">
							<input id="option1" name="_pagetype" type="radio" value="3"<?php if(!$R['uid']||$R['pagetype']==3):?> checked<?php endif?>>
							직접꾸미기 
						</a>
						<a href="#widgetBox" class="btn btn-default<?php if($R['pagetype']==2):?> active<?php endif?>" data-toggle="tab" onclick="document.procForm1.pagetype.value='2';">
							<input id="option2" name="_pagetype" type="radio" value="2"<?php if($R['pagetype']==2):?> checked<?php endif?>>
							위젯전시 
						</a>
						<a href="#jointBox" class="btn btn-default<?php if($R['pagetype']==1):?> active<?php endif?>" data-toggle="tab" onclick="document.procForm1.pagetype.value='1';">
