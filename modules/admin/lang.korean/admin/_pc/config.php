<!-- 시스템 환경 -->
<form name="sendForm" action="<?php echo $g['s']?>/" method="post" onsubmit="return sendCheck(this);" class="form-horizontal" role="form">
...
<form name="procForm" action="<?php echo $g['s']?>/" method="post" onsubmit="return saveCheck(this);" class="form-horizontal" role="form">
	<input type="hidden" name="r" value="<?php echo $r?>" />
	<input type="hidden" name="m" value="<?php echo $module?>" />
	...
	<div class="form-group">
		...
		<div class="col-lg-6">
			<label class="radio-inline">
			  <input type="radio" name="optionsRadios" value="1" checked="checked"> Light Gray
			</label>
			<label class="radio-inline">
			  <input type="radio" name="optionsRadios" value="2"> Dark Gray
			</label>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-lg-6">
			<label class="radio-inline">
			  <input type="radio" name="optionsRadios2" value="1" checked="checked"> Blue
			</label>
			<label class="radio-inline">
			  <input type="radio" name="optionsRadios2" value="2"> Red
			</label>
			<label class="radio-inline">
			  <input type="radio" name="optionsRadios2" value="3"> Green
			</label>
			<label class="radio-inline">
			  <input type="radio" name="optionsRadios2" value="4"> Yellow
			</label>
		</div>
	</div>
