        ...
        <div class="media-frame">
            <div class="media-frame-menu hidden-xs">
                ...
                <div class="list-group">
                    <a class="list-group-item active" href="/rb/?r=home&m=admin&module=mediaset&front=upload_photo"><i class="fa fa-picture-o fa-lg"></i> 사진</a>
                    <a class="list-group-item" href="/rb/?r=home&m=admin&module=mediaset&front=upload_vod"><i class="fa fa-youtube-play fa-lg"></i> 동영상</a>
                </div>
            </div>
            <div class="media-frame-content">
                ...
                <!-- 본문 영역 -->
                  <ul class="nav nav-tabs hidden-xs visible-sm visible-md">
                    <li class="active"><a href="#upload" data-toggle="tab"><i class="fa fa-upload fa-lg"></i> 직접 업로드</a></li>
                    <li><a href="#urlsave" data-toggle="tab"><i class="fa fa-anchor fa-lg"></i> URL로 부터 저장</a></li>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="urlsave">
                      <div class="tab-pane-body">

                        <div class="inner">
                          <div class="well">
                            <input class="form-control input-lg" placeholder="http://" type="text" value="">
                          </div>
                          <hr>
                          <div class="row">
                              ...
                              <a title="파일명" class="thumbnail"><img src="http://farm3.static.flickr.com/2824/10580929106_a165c84a77_s.jpg" class="img-responsive"><button class="btn btn-default btn-xs" title="삭제" type="button"><i class="fa fa-times"></i></button></a>
                                    ...
                                    <div class="media-sidebar">
                                        ...
                                        <div class="media-pic">
                                            ...
                                            <img alt="" class="img-rounded img-responsive" src="http://break.kimsq.net/rb/pages/image/people/thumb/01.jpg">
                                            <div class="btn-group">
                                            <a href="/rb/pages/image/people/full/01.jpg" class="btn btn-default btn-xs" data-original-title="크게보기" data-placement="top" data-toggle="tooltip" title=""><i class="fa fa-resize-full fa-lg"></i></a>
                                            </div>
                                        ...
                                        <div class="media-name">
                                            ...
                                            <ul class="list-unstyled photo-info">
                                                <li class="text-muted">October 19, 2013</li>
                                                <li class="text-muted">500 × 318</li>
                                                <li class="text-muted">500kb</li>
                                            </ul>
                                        </div>
