...
if (!$_cat1_&&!$_cat2_)
{
	getDbInsert($table[$module.'category'],'gid,site,mbruid,type,hidden,users,name,r_num,d_regis,d_update',"'0','".$_HS['uid']."','".$my['uid']."','1','0','','$_ealbum1','0','".$date['totime']."',''");
	getDbInsert($table[$module.'category'],'gid,site,mbruid,type,hidden,users,name,r_num,d_regis,d_update',"'1','".$_HS['uid']."','".$my['uid']."','1','0','','$_ealbum2','0','".$date['totime']."',''");
	getLink('reload','','','');
}
	...
	<div class="col-md-4 col-lg-3" id="tab-content-list">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<h4>포토셋 <small class="open-sans">( Photo Set )</small></h4>
			</div>
			<div class="panel-body">
				...
				<input type="text" name="setsearch" value="<?php echo urldecode($setsearch)?>" class="form-control" placeholder="포토셋 찾기">
				</form>
			</div>
			...
			<div class="panel-footer">
				...
				<div class="input-group">
					<input type="text" name="name" class="form-control" placeholder="추가할 포토셋명 입력">
	...
	<div class="col-md-8 col-lg-9 hidden-xs" id="tab-content-view">
		...
		<div class="page-header clearfix">
			...
			<div class="btn-group pull-right">
			  <button type="button" class="btn btn-primary btn-lg" onclick="getModal('_HiddenModal_','<?php echo $g['s']?>/?r=<?php echo $r?>&m=<?php echo $m?>&module=<?php echo $module?>&front=_modal_.photo&album=<?php echo $album?>&type=upload');"><i class="fa fa-cloud-upload fa-lg"></i>  사진 추가</button>
			  <button type="button" class="btn btn-primary dropdown-toggle btn-lg" data-toggle="dropdown">
				<span class="caret"></span>
			  </button>
			  <ul class="dropdown-menu" role="menu">
				<li><a href="#." onclick="getModal('_HiddenModal_','<?php echo $g['s']?>/?r=<?php echo $r?>&m=<?php echo $m?>&module=<?php echo $module?>&front=_modal_.photo&album=<?php echo $album?>&type=upload');"><i class="fa fa-cloud-upload fa-lg pull-right"></i> 직접 업로드</a></li>
				<li><a href="#." onclick="getModal('_HiddenModal_','<?php echo $g['s']?>/?r=<?php echo $r?>&m=<?php echo $m?>&module=<?php echo $module?>&front=_modal_.photo&album=<?php echo $album?>&type=urlsave');"><i class="fa fa-link fa-lg pull-right"></i> 외부 링크추가 </a></li>
				<?php if($_CT['uid']):?>
				<li class="divider"></li>
				<?php if($_CT['uid']==$_cat2_):?>
				<li><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $module?>&amp;a=category_delete&amp;type=photo&amp;album=<?php echo $album?>&amp;nocat=<?php echo $_cat1_?>&amp;trash=<?php echo $_cat2_?>" onclick="return hrefCheck(this,true,'정말로 삭제하시겠습니까?');"><i class="fa fa-remove fa-lg pull-right"></i> 휴지통 <small class="text-muuted"></small> 비우기</a></li>
				<?php else:?>
				...
				<li><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $module?>&amp;a=category_delete&amp;type=photo&amp;album=<?php echo $album?>&amp;nocat=<?php echo $_cat1_?>&amp;trash=<?php echo $_cat2_?>" onclick="return hrefCheck(this,true,'정말로 삭제하시겠습니까?');"><i class="fa fa-remove fa-lg pull-right"></i> 셋트 <small class="text-muuted"></small> 삭제</a></li>
				<?php endif?>
			  </ul>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-3">
					<div class="thumbnail<?php if($_i==0):?> active<?php endif?>">
						<img src="<?php echo $_R['url']?>/<?php if($_R['size']):?>thumb1_<?php endif?><?php echo $_R['name']?>"  alt="<?php echo $_R['alt']?>" class="img-responsive">
						<div class="btn-group">
	...
	<div class="modal-body">
		...
		<div id="set">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-3">
					<div class="thumbnail">
						<img src="<?php echo $_R['url']?>/<?php echo $_R['name']?>"  alt="<?php echo $_R['alt']?>" class="img-responsive">
						<div class="btn-group">
...
(function(window, PhotoSwipe){
	document.addEventListener('DOMContentLoaded', function(){
		var
			options = {},
			instance = PhotoSwipe.attach( window.document.querySelectorAll('#set a'), options );
	}, false);
...
<div class="row">
	<div class="col-lg-8">
		...
		<div class="page-header clearfix">
			<h4 class="pull-left"><i class="fa fa-pencil fa-lg"></i> 사진 수정하기 </h4>
			<span class="pull-right action"><button type="button" class="btn btn-default" onclick="history.back();"><i class="fa fa-angle-left"></i> 이전</button></span>
		</div>
		...
		<input type="hidden" name="uid" value="<?php echo $_R['uid']?>" />
		  ...
		  <div class="form-group">
			<label for="inputName" class="col-lg-2 control-label">파일명</label>
			<div class="col-lg-10">
			  <input type="text" name="name" class="form-control" id="inputName" value="<?php echo str_replace('.'.$_R['ext'],'',$_R['name'])?>"<?php if(!$_R['size']):?> readonly<?php endif?>>
			</div>
		  </div>
		  <div class="form-group">
			<div class="col-lg-offset-2 col-lg-10">
			<img src="<?php echo $_R['url']?>/<?php echo $_R['name']?>" alt="<?php echo $_R['alt']?>" class="img-responsive img-thumbnail">
			</div>
		  </div>
		  <div class="form-group">
			<label for="inputFile" class="col-lg-2 control-label">사진변경</label>
			<div class="col-lg-10">
				<input type="file" name="upfiles[]" id="inputFile">
				<p class="help-block">변경할 사진을 첨부해 주세요</p>
			</div>
		  </div>
		  <div class="form-group">
			...
			<div class="col-lg-10">
				<div class="well">
					<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-picture-o fa-lg"></i> 원본</span>
					<input class="form-control" type="text" value="<?php echo $_R['url']?>/<?php echo $_R['name']?>">
					<span class="input-group-btn">
					<a href="<?php echo $_R['url']?>/<?php echo $_R['name']?>" target="_blank" class="btn btn-default"> <i class="fa fa-external-link fa-lg"></i> </a>
					</span>
					</div>

					<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-picture-o fa-lg"></i> 중</span>
					<input class="form-control" type="text" value="<?php echo $_R['url']?>/<?php if($_R['size']):?>thumb1_<?php endif?><?php echo $_R['name']?>">
					<span class="input-group-btn">
					<a href="<?php echo $_R['url']?>/<?php if($_R['size']):?>thumb1_<?php endif?><?php echo $_R['name']?>" target="_blank" class="btn btn-default"> <i class="fa fa-external-link fa-lg"></i> </a>
					</span>
					</div>			    	
					<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-picture-o fa-lg"></i> 소</span>
					<input class="form-control" type="text" value="<?php echo $_R['url']?>/<?php if($_R['size']):?>thumb2_<?php endif?><?php echo $_R['name']?>">
					<span class="input-group-btn">
					<a href="<?php echo $_R['url']?>/<?php if($_R['size']):?>thumb2_<?php endif?><?php echo $_R['name']?>" target="_blank" class="btn btn-default"> <i class="fa fa-external-link fa-lg"></i> </a>
					</span>
					</div>
	...
	<li class="list-group-item form-horizontal">
		...
		<li class="list-group-item form-horizontal">
			<div class="form-group">
				...
				<div class="col-lg-9"><p class="form-control-static"><?php echo getDateFormat($_R['d_update']?$_R['d_update']:$_R['d_regis'],'Y.m.d H:i')?></p></div>
				</div>
			</li>
			<li class="list-group-item form-horizontal">
				<div class="form-group">
					<label class="col-lg-3 control-label">파일명</label>
					<div class="col-lg-9"><p class="form-control-static"><?php echo $_R['name']?></p></div>
					</div>
				</li>
				<li class="list-group-item form-horizontal">
					<div class="form-group">
						<label class="col-lg-3 control-label">용량</label>
						<div class="col-lg-9"><p class="form-control-static"><?php echo $_R['size'] ? getSizeFormat($_R['size'],1) : '외부파일'?> </p></div>
						</div>
					</li>
				<li class="list-group-item form-horizontal">
					<div class="form-group">
						<label class="col-lg-3 control-label">크기</label>
						<div class="col-lg-9"><p class="form-control-static"><?php if($_R['size']):?><?php echo $_R['width']?>px × <?php echo $_R['height']?>px<?php else:?>외부파일<?php endif?></p></div>
						</div>
					</li>
					<li class="list-group-item form-horizontal">
						<div class="form-group">
