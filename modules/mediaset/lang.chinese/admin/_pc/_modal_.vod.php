<?php include $g['path_module'].$module.'/_func.php'?>
            ...
            <div class="media-frame-content">
                ...
                <!-- 본문 영역 -->
                  ...
                  <div class="tab-content">
					...
					<input type="hidden" name="r" value="<?php echo $r?>" />
					<input type="hidden" name="m" value="<?php echo $module?>" />
					<input type="hidden" name="a" value="vod_link" />
					...
					<input type="hidden" name="siteaply" value="<?php echo $_HS['uid']?>" />
                      ...
                      <div class="tab-pane-body">
                        ...
                        <div class="inner">
                          ...
                          <div class="well">
                            <textarea name="link" id="_vod_embed_code_" class="form-control" rows="5"></textarea>
                            <button type="button" class="btn btn-default btn-block" style="margin-top:10px" onclick="getVodPreview();">불러오기</button>
                          </div>
                          <hr>
                          <div class="row">
                            <div class="col-sm-4 col-md-4 col-lg-4" id="_vod_play_layer_"><img class="img-thumbnail img-responsive" src="<?php echo $g['img_core']?>/blank.gif"></div>
...
?>
							...
							<a title="<?php echo $_R['name']?>" class="thumbnail" onclick="getModal('_HiddenSideBar_','<?php echo $g['s']?>/?r=<?php echo $r?>&m=<?php echo $m?>&module=<?php echo $module?>&front=_modal_.vod_data&uid=<?php echo $_R['uid']?>');"><img src="<?php echo getVodThumb($_R['link'],0)?>" width="75" height="75" class="img-responsive"><button class="btn btn-default btn-xs" title="삭제" type="button" onclick="deleteFile1('<?php echo $_R['uid']?>','vod','<?php echo $album?>');"><i class="fa fa-times"></i></button></a>
							<?php endwhile?>
                            </div>
