...
<div id="mjointbox">
	...
	<div class="wg">
	<script src="http://widgetprovider.daum.net/view?url=http://widgetcfs1.daum.net/xml/5/widget/2009/04/23/10/36/49efc62b79a6e.xml&up_DAUM_WIDGETBANK_BLOG_URL=&&width=166&height=272&widgetId=362&scrap=1" type="text/javascript"></script>
	</div>
...
function getWidgetCode()
{
	...
	<?php if(!$option):?>
	opener.createTile('166px','272px','0px','0px');
	<?php endif?>

	opener.blocktitle[n] = "방문자위치";
