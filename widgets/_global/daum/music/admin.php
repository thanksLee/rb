...
<div id="mjointbox">
	...
	<div class="wg">
	<script src="http://widgetprovider.daum.net/view?url=http://widgetcfs1.daum.net/xml/29/widget/2009/09/10/13/47/4aa884ec5779c.xml&&width=166&height=249&widgetId=491&scrap=1" type="text/javascript"></script>
	</div>
...
function getWidgetCode()
{
	...
	<?php if(!$option):?>
	opener.createTile('166px','249px','0px','0px');
	<?php endif?>

	opener.blocktitle[n] = "다음뮤직";
