...
if ($changeType == 'front')
{
	if ($d['layout']['mainType_layout']&&$mainType_layout)
	{
		...
		$d['layout']['shortcut'] = trim($shortcut);
		$d['layout']['category'] = trim($category);
...
if ($changeType == 'detail')
{
	...
	$d['layout']['topmenu_color'] = $topmenu_color;
	$d['layout']['topmenu_color1'] = $topmenu_color1;
	$d['layout']['topmenu_colorbg'] = $topmenu_colorbg;
