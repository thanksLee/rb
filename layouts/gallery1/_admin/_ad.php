...
광고의 높이는 제한이 없으나 광고의 폭은 가로 240 픽셀에 고정됩니다.<br />
</div>
...
<td class="t3">
<br />
<img src="<?php echo $g['s'].'/layouts/'.$d['layout']['dir'].'/_var/'.$d['layout']['ad_img']?>" width="240" alt="" />
<br /><br />
...
<td class="t3">
<br />
<embed src="<?php echo $g['s'].'/layouts/'.$d['layout']['dir'].'/_var/'.$d['layout']['ad_swf']?>" width="240"></embed>
<br /><br />
