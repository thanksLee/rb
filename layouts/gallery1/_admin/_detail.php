...
<td class="t2">:</td>
<td class="t3">
	<input type="text" name="title_padding_top" class="input sf" value="<?php echo $d['layout']['title_padding_top']?>" maxlength="3" /> /
	<input type="text" name="title_padding_btm" class="input sf" value="<?php echo $d['layout']['title_padding_btm']?>" maxlength="3" /> <span class="small">픽셀</span>
</td>
</tr>

<tr>
<td class="t1">단축메뉴 색상(기본)</td>
<td class="t2">:</td>
<td class="t3">
	<input type="text" name="topmenu_color" id="topmenu_color_" class="input sf1" value="<?php echo $d['layout']['topmenu_color']?>" />
	<img src="<?php echo $g['img_core']?>/_public/btn_color.gif" class="hand" alt="" onclick="getLayerBox('<?php echo $g['s']?>/_core/opensrc/colorjack/color.php?color=<?php echo substr($d['layout']['topmenu_color'],1,6)?>&dropf=topmenu_color_&callback=colorChange','색상선택',220,260,event,'','r');" />
	<span class="small">(공백:기본값)</span>
</td>
</tr>

<tr>
<td class="t1">단축메뉴 색상(선택)</td>
<td class="t2">:</td>
<td class="t3">
	<input type="text" name="topmenu_color1" id="topmenu_color1_" class="input sf1" value="<?php echo $d['layout']['topmenu_color1']?>" />
	<img src="<?php echo $g['img_core']?>/_public/btn_color.gif" class="hand" alt="" onclick="getLayerBox('<?php echo $g['s']?>/_core/opensrc/colorjack/color.php?color=<?php echo substr($d['layout']['topmenu_color1'],1,6)?>&dropf=topmenu_color1_&callback=colorChange','색상선택',220,260,event,'','r');" />
	<span class="small">(공백:기본값)</span>
</td>
</tr>

<tr>
<td class="t1">단축메뉴 배경(선택)</td>
<td class="t2">:</td>
<td class="t3">
	<input type="text" name="topmenu_colorbg" id="topmenu_colorbg_" class="input sf1" value="<?php echo $d['layout']['topmenu_colorbg']?>" />
	<img src="<?php echo $g['img_core']?>/_public/btn_color.gif" class="hand" alt="" onclick="getLayerBox('<?php echo $g['s']?>/_core/opensrc/colorjack/color.php?color=<?php echo substr($d['layout']['topmenu_colorbg'],1,6)?>&dropf=topmenu_colorbg_&callback=colorChange','색상선택',220,260,event,'','r');" />
	<span class="small">(공백:기본값)</span>
</td>
</tr>
...
<td class="t2">:</td>
<td class="t3">
	<input type="text" name="title_t" class="input sf" value="<?php echo $d['layout']['title_t']?>" maxlength="3" />/<input type="text" name="title_b" class="input sf" value="<?php echo $d['layout']['title_b']?>" maxlength="3" /> <span class="small">픽셀</span>
</td>
</tr>
<tr>
...
<input type="checkbox" name="bg_use" value="1"<?php if($d['layout']['bg_use']):?> checked="checked"<?php endif?> />배경 이미지/CSS 사용함
</td>
</tr>
<tr>
...
<td class="t2">:</td>
<td class="t3">
<input type="text" name="bg_o" id="bg_o" class="input" value="<?php echo $d['layout']['bg_o']?>" />
