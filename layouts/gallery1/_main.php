...
if ($d['layout']['topmenu_color']) $d['layout']['_shortcut_color'] = ' style="color:'.$d['layout']['topmenu_color'].';"';
if ($d['layout']['topmenu_color1']) $d['layout']['_shortcut_color1'] = ' style="font-weight:bold;color:'.$d['layout']['topmenu_color1'].';"';
if ($d['layout']['topmenu_colorbg']) $d['layout']['_shortcut_bg'] = ' style="background:'.$d['layout']['topmenu_colorbg'].';border-radius:4px 4px 4px 4px;box-shadow:0 1px 0 '.$d['layout']['topmenu_colorbg'].';"';
if ($d['layout']['memberlink_color']) $d['layout']['_memberlink_color'] = ' style="color:'.$d['layout']['memberlink_color'].';"';

$d['layout']['subtitle'] = $_HM['name'] ? $_HM['name'] : $_tmp['location']['name'];
$d['layout']['subtitle'] = $d['layout']['subtitle'] ? $d['layout']['subtitle'] : '';
if ($_shortcut) $d['layout']['subtitle'] = $_shortcut;
