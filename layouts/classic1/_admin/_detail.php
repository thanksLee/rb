...
<tr>
<td class="t1">상단 메세지</td>
<td class="t2">:</td>
<td class="t3">
	<input type="text" name="message" class="input" value="<?php echo $d['layout']['message']?>" /> 색상코드
	<input type="text" name="message_color" id="message_color_" class="input sf1" value="<?php echo $d['layout']['message_color']?>" />
	<img src="<?php echo $g['img_core']?>/_public/btn_color.gif" class="hand" alt="" onclick="getLayerBox('<?php echo $g['s']?>/_core/opensrc/colorjack/color.php?color=<?php echo substr($d['layout']['message_color'],1,6)?>&dropf=message_color_&callback=colorChange','색상선택',220,260,event,'','r');" />
	<span class="small">(공백:기본값)</span>
</td>
</tr>
...
<tr>
<td class="t1">전체 배경CSS</td>
<td class="t2">:</td>
<td class="t3">
<input type="text" name="bg_o" id="bg_o" class="input" value="<?php echo $d['layout']['bg_o']?>" />
<a href="#." onclick="getId('bg_o').value='center top repeat-x #ffffff';getId('bg_o').focus();">기본값(반복)</a>
<a href="#." onclick="getId('bg_o').value='top center no-repeat #ffffff';getId('bg_o').focus();">상단 무반복</a>
<a href="#." onclick="getId('bg_o').value='center center no-repeat #ffffff';getId('bg_o').focus();">중앙 무반복 </a>
</td>
</tr>
