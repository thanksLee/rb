...
<td class="t2">:</td>
<td class="t3">
	<input type="text" name="ment" class="input" value="<?php echo $d['layout']['ment']?>" /> 색상코드
	<input type="text" name="title_color1" id="title_color1_" class="input sf1" value="<?php echo $d['layout']['title_color1']?>" maxlength="7" />
	<img src="<?php echo $g['img_core']?>/_public/btn_color.gif" class="hand" alt="" onclick="getLayerBox('<?php echo $g['s']?>/_core/opensrc/colorjack/color.php?color=<?php echo substr($d['layout']['title_color1'],1,6)?>&dropf=title_color1_&callback=colorChange','색상선택',220,260,event,'','r');" /> 
	<span class="small">(공백:기본값)</span>
</td>
</tr>
...
<td class="t3">
	...
	<input type="text" name="title_b" class="input sf" value="<?php echo $d['layout']['title_b']?>" maxlength="3" /> <span class="small">픽셀</span>
</td>
</tr>
<tr>
