...
<td class="t3">
<br />
<img src="<?php echo $g['s'].'/layouts/'.$d['layout']['dir'].'/_var/'.$d['layout']['ad_img']?>" width="470" height="60" alt="" />
<br /><br />
...
<td class="t3">
<br />
<embed src="<?php echo $g['s'].'/layouts/'.$d['layout']['dir'].'/_var/'.$d['layout']['ad_swf']?>" width="570" height="60"></embed>
<br /><br />
