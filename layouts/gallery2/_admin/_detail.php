...
<td class="t2">:</td>
<td class="t3">
	<input type="text" name="ment" class="input post" value="<?php echo $d['layout']['ment']?>" />
</td>
</tr>
...
<input type="checkbox" name="imgphoto_use" value="1"<?php if($d['layout']['imgphoto_use']):?> checked="checked"<?php endif?> />사용함 <span class="small">(가로 180픽셀 고정 , 세로는 가로비율 유지)</span>
</td>
</tr>

<?php if(is_file($g['path_layout'].$d['layout']['dir'].'/_var/'.$d['layout']['imgphoto'])):?>
<tr>
<td></td>
<td></td>
<td class="t3">
<br />
<img src="<?php echo $g['s'].'/layouts/'.$d['layout']['dir'].'/_var/'.$d['layout']['imgphoto']?>" width="180" alt="" />
<br /><br />
<a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;_layoutAction=logodelete&amp;&imgType=photo&amp;nowLayout=<?php echo $d['layout']['dir']?>" onclick="return hrefCheck(this,true,'정말로 삭제하시겠습니까?');">이 사진을 삭제하기</a>
<br />
<br />
</td>
</tr>
